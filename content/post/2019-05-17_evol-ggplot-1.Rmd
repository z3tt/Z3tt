...
df_ratios %>%
  ggplot(aes(x = x, y = y, fill = student_ratio)) +
    ...
    theme(legend.position = c(0.5, 0),
          ...
          line = element_blank(),
          plot.caption = element_text(family = "Poppins", color = "gray50"),
...
after <- df_ratios %>%
  ...
  ggplot(aes(region, student_ratio, color = region)) +
    ...
    theme(legend.position = "none", 
          plot.caption = element_text(size = 7, family = "Poppins", color = "gray50"),
...
median <- df_ratios %>%
  ...
  ggplot(aes(region, student_ratio, color = region)) +
    ...
    annotate("text", x = 1.7, y = 9.5, family = "Poppins", size = 2.7, color = "gray20",
             label = "Countries per continent") +
    annotate("text", x = 1.9, y = 64, family = "Poppins", size = 2.7, color = "gray20",
             label = "The Central African Republic has by far\nthe most students per teacher") +
    geom_curve(data = arrows, aes(x = x1, y = y1, xend = x2, yend = y2),
