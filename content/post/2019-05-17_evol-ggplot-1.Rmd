...
Note that we could also use `geom_point(aes(region, student_ratio_region), size = 5)` to achieve the same since we already have a regional meanaverage in our data.
