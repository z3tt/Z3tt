...
You can also set the seed within the `geom_jitter()` call:

```{r plot-jitter-seed, fig.width = 8, fig.heigh = 4.5}
g + geom_jitter(position = position_jitter(seed = 2019, width = 0.2), size = 2, alpha = 0.25)
```

(Here, I am going to use the redundant call of `set.seed(2019)` in the next code chunks.)
...
arrows <- tibble(
  x1 = c(6, 3.65, 1.8, 1.8, 1.8),
  x2 = c(5.6, 4, 2.07, 2.78, 0.9),
  y1 = c(world_med + 6, 10.5, 9, 9, 76),
  y2 = c(world_med + 0.1, 18.4, 14.4, 12, 83.41195)
)
