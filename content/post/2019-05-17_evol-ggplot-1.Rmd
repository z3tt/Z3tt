...
twitterImg: img/banner/dark_RichardStrozynski.png
layout: post
showtoc: false
...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, fig.showtext = TRUE, retina = 2)
```
...
```{r arrows-annotations, fig.width = 8, fig.heigh = 4.5}
arrows <-
  tibble(
...
before <-
  ggplot(df_ratios, aes(x = region, y = student_ratio)) +
    ...
    theme(plot.title = element_text(family = "Poppins", size = 2.80, face = "bold", hjust = 0.5))
...
```{r mean-vs-mean, echo=FALSE, message=FALSE, fig.width = 8.5, fig.height = 11}
world_med <-
  df_ratios %>%
...
(g_end + labs(title = "Mean ratios", caption = "") +
