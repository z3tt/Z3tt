...
<img src="/img/ggplot-tutorial/overview.png" style="height: 100%; width: 100%; object-fit: contain" onclick="window.open('https://cedricscherer.com/img/ggplot-tutorial/overview.png', 'blank');"/>
...
* You can also download the R script containing only the code [here](https://cedricscherer.com/codes/ggplot-tutorial-cedric-raw.R).
