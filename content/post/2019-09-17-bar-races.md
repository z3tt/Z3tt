...
twitterImg: img/bar-races/berlin_temp_diff_dec.png
tags:
    - DataViz
    - animations
    - Berlin
...
> <p id="back3"><br>
></p>Also me: Maybe I should jump on the hype train before it's gone<a href="#section3"><sup>3</sup></a> and write bla og post.
...
<img src="/img/bar-races/dwd_anim_diff_yrs_long_fif" alt="GIF Chart Race Difference Temperatures (all years)">
