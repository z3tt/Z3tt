...
title: Jumping on the Hype Train – Visualizing Temperatures in Berlin with Bar Chart Races
author: Cédric
date: "2019-09-17"
image: img/banner/dark_RichardStrozynski.jpg
layout: post
description: "You have seen Bar Chart Races. You have seen Bart Chart Races of Bar Chart Races. Here come some more using temperature data in Berlin using `ggplot2` and `gganimate`."
tags:
    - ggplot2
    - gganimate
    - R
