...
2Of course, different geoms can also be combined to provide even more information in one plot:
...
2 **Remove the outliers to avoid overlapping points! You can achieve this via `outlier.shape = NA` or `outlier.alpha = 0`.**
