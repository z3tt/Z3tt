...
layout: post
showtoc: false
description: "While preparing the mappingsection for a Pearson–O'Reilly training, I got the idea to visualize the first letter of each country. And got especially curious about how much landmass each letter covers. Turns out: A, C and R are covering the largest areas!"
...
<p><figcaption class="small" align="center" style="color:#8c8c8c;font-style:italic;">The final poster version with the colorful overview map and 25 small maps, one for each letter.</figcaption></p>
...
* A cyclical color palette; of course, 25 categories are too many but with this approach one can identify the range a country falls into.
* Color-vision deficiency problems are likely but not problematic thanks to the small multiples.
* I took hours to find a good palette as well as a font I liked: I settled on [Neco Black](https://www.fontshare.com/fonts/neco) for the title and letters and [Chivo](https://www.omnibus-type.com/fonts/chivo/) with it's tabular numbers for the areas and the caption.
...
* Data Preparation: [`{stringr}` R package](https://stringr.tidyverse.org/) and [`{sf}` R package](https://r-spatial.github.io/sf/)
* Graphics: [`{ggplot2}`](https://ggplot2.tidyverse.org/) and [`{ggtext}`](https://wilkelab.org/ggtext/)
* Colors: [Tableau cyclic color palette](https://help.tableau.com/current/pro/desktop/en-us/formatting_create_custom_colors.htm) via the [`{ggthemes}` R package](https://jrnold.github.io/ggthemes/index.html)
...
<img src="https://www.cedricscherer.com/img/world-by-letters/last_letter_world_v1.png" style="height: 100%; width: 100%; object-fit: contain" onclick="window.open('https://www.cedricscherer.com/img/world-by-letters/letter_world_v1.png', 'blank');">

<img src="https://www.cedricscherer.com/img/world-by-letters/last_letter_world_v2.png" style="height: 100%; width: 100%; object-fit: contain" onclick="window.open('https://www.cedricscherer.com/img/world-by-letters/letter_world_v2.png', 'blank');">
