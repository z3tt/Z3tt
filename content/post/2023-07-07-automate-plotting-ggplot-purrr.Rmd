...
```
```{r run-embraced-function-1, fig.cap='An example using the function with embracing without passing a color column.'}
plot_scatter_lm_embraced(data = mpg, var1 = displ, var2 = hwy)
```
```{r run-embraced-function-2, fig.cap='An example using the function with embracing, passing a quantitative variable to color.'}
plot_scatter_lm_embraced(data = mpg, var1 = displ, var2 = hwy, color = cyl)
```
```{r run-embraced-function-3, fig.cap='An example using the function with embracing, passing a qualitative variable to color.'}
