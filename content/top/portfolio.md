...
- <span style='font-variant:small-caps;'>L Figueiredo, <u style='font-weight:700;color:#414141;'>C Scherer</u> & JS Cabral</span> (accepted)</span> A simple kit to use computational notebooks for more openness, reproducibility, and
productivity in research. *PLOS Computational Biology*.  
